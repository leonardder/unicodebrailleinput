...
class B2UDialog(gui.SettingsDialog):
	...
	def makeSettings(self, sizer):
		...
		inputTypeChoices=[
			...
			# Translators: the label of an input type
			_("Regular text according to current braille input table")
		]
		...
		self._brailleTextEdit = sizerHelper.addLabeledControl(_("Enter text in numeric braille:"),wx.TextCtrl)
